...
library(tidyverse)
library(readr)
genes <- read_tsv("C:/Users/Laurids/Kode/Evolutionary_Thinking_2024/week45/Friday/data/genes.txt")
```
...
```{r}
variants <- read_tsv("C:/Users/Laurids/Kode/Evolutionary_Thinking_2024/week45/Friday/data/variants.txt")
```
...
```{r}
copyNumbers <- read_tsv("C:/Users/Laurids/Kode/Evolutionary_Thinking_2024/week45/Friday/data/copyNumbers.txt")
```
